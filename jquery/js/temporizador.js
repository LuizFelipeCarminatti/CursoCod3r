(function ($) {
    $.fn.temporizador = function (opcoes) {
        ...
        $(this).append(diaDezena, diaUnidade, separadorDia, horaDezena, horaUnidade, separadorHora,
        ...
        let temporizador = setInterval(() => {
            ...
            const diferencaDias = alvo.getDay()
            const diferenca1 = regex2.exec(new Date(diferencaDias).toISOString())

                diaDezena.html(diferenca1[1][0])
                diaUnidade.html(diferenca1[1][1])
